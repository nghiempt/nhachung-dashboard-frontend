  ...
  return (
    <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: "16px", height: "100%", overflow: "hidden" }}>
      ...
      <div style={{ flexShrink: 0 }}>
        <h1 style={{ fontSize: "28px", fontWeight: 700, lineHeight: "36px", color: "#272727" }}>AI Trợ lý</h1>
        <p style={{ fontSize: "16px", color: "#585c7b", marginTop: "6px", lineHeight: "24px", fontWeight: 500 }}>Trợ lý AI cho Ban quản trị Landmark 1</p>
      </div>
