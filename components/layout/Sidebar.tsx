...
const navSections: NavSection[] = [
  {
    items: [
      ...
      },
      {
        href: "/thong-bao",
        label: "Thông báo",
        iconPath: "/icons/sidebar/thong-bao.svg",
        badge: "298",
      ...
      },
      {
        href: "/kho-tai-lieu",
        label: "Kho tài liệu",
        iconPath: "/icons/sidebar/kho-tai-lieu.svg",
      },
      {
        href: "/gop-y",
        label: "Góp ý / Phản ánh",
        iconPath: "/icons/sidebar/gop-y-phan-anh.svg",
      },
      {
        href: "/tin-tuc",
        label: "Tin tức cộng đồng",
        iconPath: "/icons/sidebar/tin-tuc-cong-dong.svg",
      },
      {
        href: "/ai-assistant",
        label: "AI Assistant",
        iconPath: "/icons/sidebar/ai-assistant.svg",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        iconPath: "/icons/sidebar/tong-quan-tai-chinh.svg",
      },
      {
        href: "/thu-chi",
        label: "Báo cáo thu chi",
        iconPath: "/icons/sidebar/bao-cao-thu-chi.svg",
      },
      {
        href: "/quy-bao-tri",
        label: "Quỹ bảo trì",
        iconPath: "/icons/sidebar/quy-bao-tri.svg",
      },
      {
        href: "/van-hanh",
        label: "Vận hành & bảo trì",
        iconPath: "/icons/sidebar/van-hanh-bao-tri.svg",
      },
      {
        href: "/kpi",
        label: "KPI Ban quản trị",
        iconPath: "/icons/sidebar/kpi-ban-quan-tri.svg",
      },
      {
        href: "/bao-cao",
        label: "Báo cáo định kỳ",
        iconPath: "/icons/sidebar/bao-cao-dinh-ky.svg",
      },
      {
        href: "/lich-su",
        label: "Lịch sử & lưu trữ",
        iconPath: "/icons/sidebar/lich-su-luu-tru.svg",
      },
    ],
  },
  {
    ...
    items: [
      {
        href: "/ho-so",
        label: "Hồ sơ cá nhân",
        iconPath: "/icons/sidebar/ho-so-ca-nhan.svg",
      },
      {
        href: "/gia-dinh",
        label: "Thành viên gia đình",
        iconPath: "/icons/sidebar/thanh-vien-gia-dinh.svg",
      },
      {
        href: "/can-ho",
        label: "Căn hộ của tôi",
        iconPath: "/icons/sidebar/can-ho-cua-toi.svg",
      },
      {
        href: "/cai-dat",
        label: "Cài đặt",
        iconPath: "/icons/sidebar/cai-dat.svg",
      },
    ],
  },
];
                ...
                >
                  <span
                    ...
                    style={{
                      ...
                      height: 20,
                      flexShrink: 0,
                      background: isActive ? "#4137f9" : "rgba(0,0,0,0.45)",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px", borderRadius: "8px", cursor: "pointer", color: "#585c7b" }}>
          <span
            ...
            style={{
              ...
              height: 20,
              background: "#585c7b",
              maskImage: 'url("/icons/sidebar/sidebar-collapse.svg")',
              WebkitMaskImage: 'url("/icons/sidebar/sidebar-collapse.svg")',
              maskPosition: "center",
              WebkitMaskPosition: "center",
              maskRepeat: "no-repeat",
              WebkitMaskRepeat: "no-repeat",
